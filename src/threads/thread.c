...
thread_tick (void) 
{
  ...
  {  
    ...
    while((!list_empty(&sleeping_queue)) && current_time >= sleeping_queue_top_thread->wk_time)
    {
...
{
  // Checks if the ready list is empty
               ...
               thread_func *function, void *aux) 
{
  ...
  /* #### 
  Purpose : Call to the function which yields the process if priority of the process
            waiting in the ready queue is higher then thread_current()'s priority.
  ####
  */
  old_level = intr_disable();
